"""
Essa classe LogEntry foi copiada da LogEntry original do AuditLog.
A única mudança foi que o campo actor será uma string pois na Arquitetura
dos projetos da Instruct o Usuário não fica nas aplicações e sim numa aplicação externa
"""
...
class LogEntryManager(models.Manager):
    ...
    def log_create(self, instance, **kwargs):
        ...
        if changes is not None:
            ...
            get_additional_data = getattr(
                instance, "get_additional_data", None
            )
